...
func writePenelopeClioServiceAttachmentsFile( fromClioMatters: [ClioMatter], fromClioContacts: [ClioContact])
{
    ...
    // Matters don't always mean attachments
...
func writePenelopeIndividualsFile( fromContacts : [TitaniumClientContact] , fromDemographics : [TitaniumDemographic], fromCIS: [TitaniumCIS], fromHotline : [TitaniumHotline], fromClio : [ClioContact], fromAdultShelter : [TitaniumAdultShelter], fromChildShelter: [TitaniumChildShelter] )
{
    ...
    for person in fromClio
    {
        if( excludeList.contains( String(person.ClientID) ) == false )
        {
            ...
            let indLanguage = MapQ1848( language: person.Language )
            ...
            let output : String = String(person.ClientID) + "," + name + "," + " " + "," + lastName + " , " + " " + "," + "Female" + "," + birthDate + "," + "Outreach" + "," + language + "," + " " + "," + " "
                + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + indLanguage + "," + " " + "," + " " + "," + " " + "," + notes + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + ",\"" + " " + "\",\"" + " " + "\",\"" + " " + "\",\"" + " " +  "\",\"" + " " + "\",\"" + " " + "\",\"" + " " + "\"," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "\n"
    ...
    // Write the hotline only contacts
    for person in fromAdultShelter
    {
        if( excludeList.contains( String(person.ClientID) ) == false )
        {
            count = count + 1
            ...
            var name     = person.FirstName + " " + person.MiddleName
            ...
            //10 race
            // 13 language
            let race = MapQ1844( titanium: person.q1482 )
        
            
            let language = MapQ1848( language: person.q1484 )
            let indLanguage = MapQ1847( language: person.q1484 )
            
            var notes = ""
            
            
            let output : String = String(person.ClientID) + "," + name + "," + " " + "," + lastName + " , " + " " + "," + "Female" + "," + " " + "," + "Shelter" + "," + language + "," + " " + "," + " "
                + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + indLanguage + "," + " " + "," + " " + "," + " " + "," + notes + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + race + "," + " " + "," + " " + "," + " " + "," + " " + ",\"" + " " + "\",\"" + " " + "\",\"" + " " + "\",\"" + " " +  "\",\"" + " " + "\",\"" + " " + "\",\"" + " " + "\"," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "\n"
        ...
        // Write the hotline only contacts
        for person in fromChildShelter
        {
            if( excludeList.contains( String(person.ClientID) ) == false )
            {
                count = count + 1
                ...
                let race = MapQ1844( titanium: person.q1480 )
                
                let gender = MapGender( from: person.q1482 )
                ...
                let output : String = String(person.ClientID) + "," + name + "," + " " + "," + lastName + " , " + " " + "," + gender + "," + " " + "," + "Shelter" + "," + language + "," + " " + "," + " "
                    + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + indLanguage + "," + " " + "," + " " + "," + " " + "," + notes + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + race + "," + " " + "," + " " + "," + " " + "," + " " + ",\"" + " " + "\",\"" + " " + "\",\"" + " " + "\",\"" + " " +  "\",\"" + " " + "\",\"" + " " + "\",\"" + " " + "\"," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "," + " " + "\n"
